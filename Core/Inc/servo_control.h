 ...
 *
 *    - Vùng THẤP  (pulse < SERVO_ZONE_LOW_MAX)  : giảm CCR từng bước → xoay nghịch
 *    - Vùng GIỮA  (LOW_MAX ≤ pulse ≤ HIGH_MIN)  : giữ CCR hiện tại → dừng
 *    - Vùng CAO   (pulse > SERVO_ZONE_HIGH_MIN) : tăng CCR từng bước → xoay thuận
 *    - Mất tín hiệu (pulse == 0)                : dừng tại chỗ (giống vùng giữa)
 *
...
#define SERVO_PWM_MIN   1000U   /* Giới hạn cuối 0°   */
#define SERVO_PWM_MID   1500U   /* Vị trí khởi động 90° */
#define SERVO_PWM_MAX   2000U   /* Giới hạn cuối 180° */

/* Ngưỡng phân vùng tín hiệu RC (µs) --------------------------------------- */
#define SERVO_ZONE_LOW_MAX   1250U  /* pulse < 1250  → Vùng THẤP  (xoay nghịch) */
#define SERVO_ZONE_HIGH_MIN  1750U  /* pulse > 1750  → Vùng CAO   (xoay thuận)  */
...
/*   t = (SERVO_PWM_MAX - SERVO_PWM_MIN) / SERVO_STEP_SIZE * SERVO_STEP_INTERVAL_MS */
